...
await $`if [ ! -f installer.jar ]; then wget -O installer.jar https://maven.minecraftforge.net/net/minecraftforge/forge/1.18.2-40.1.73/forge-1.18.2-40.1.73-installer.jar; fi`;
await $`java -jar installer.jar --installServer server`;
